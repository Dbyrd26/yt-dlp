...
class XHamsterAltIE(InfoExtractor):
    ...
    def _real_extract(self, url):
        ...
        if initials:
            ...
            channels = []
            for tag in tags:
                if 'channels' in tag['url']:
                    channels.append(tag)
                elif 'pornstars' in tag['url']:
                    models.append({"id": tag['id'], 'name': tag['name']})
                elif 'categories' in tag['url']:
                    categories.append(tag['name'])
                elif 'tags' in tag['url']:
                    video_tags.append(tag['name'])
            formats = []
            format_urls = set()
            format_sizes = {}
